...
var getSeason = require('../src/what-season.js');

describe('What season', function () {
  // Presence requirement
  describe('variable presence', function () {
    it.optional('function getSeason exists', function () {
  ...
  describe('base requirements', function () {
    it.optional('returns proper value', function () {
      var winter = new Date(2019, 11, 22, 23, 45, 11, 500),
    ...
    it.optional('returns proper value if date is before 1970', function () {
      var winter = new Date(1900, 0, 22, 23, 45, 11, 500),
          spring = new Date(1354, 4, 17, 11, 27, 4, 321),
          summer = new Date(1, 6, 13, 23, 45, 11, 500),
          autumn = new Date(22, 8, 22, 3, 0, 11, 500);
      assert.equal(getSeason(winter), 'winter');
      assert.equal(getSeason(spring), 'spring');
      assert.equal(getSeason(summer), 'summer');
      expect(getSeason(autumn)).to.match(/autumn|fall/);
    });
    it.optional('returns proper value (month index)', function () {
      var winter = new Date(2025, 1, 22, 23, 45, 11, 500),
          spring = new Date(2134, 2, 17, 11, 27, 4, 321),
          summer = new Date(2012, 5, 13, 23, 45, 11, 500),
          autumn = new Date(2019, 8, 22, 3, 0, 11, 500);
      assert.equal(getSeason(winter), 'winter');
      assert.equal(getSeason(spring), 'spring');
      assert.equal(getSeason(summer), 'summer');
      expect(getSeason(autumn)).to.match(/autumn|fall/);
    ...
    it.optional('some pack of tests', function () {
  ...
  describe('extended requirements ', function () {
