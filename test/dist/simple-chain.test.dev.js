...
describe('Make chain!', function () {
  ...
  describe('functional requirements', function () {
    it.optional('function returns correct values', function () {
    ...
    it.optional('removeLinks works correctly', function () {
